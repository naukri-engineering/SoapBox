...
/**
 * Created by vishnu.anand on 9/1/2016.
 */
public class SliderNotificationData extends NotificationData implements Serializable {
    ...
    public ArrayList<SliderCard> sliderCards; // this list if used for inflating data in notifications.
